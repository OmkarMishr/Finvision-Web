...
const PurchaseDialog = ({ 
  ...
  course: { title: string; price: string; isFree?: boolean } | null;
    ...
    const handleKeyDown = (e: React.KeyboardEvent) => {
      if (e.key === ' ') {
        e.stopPropagation(); // Stops Radix from capturing spacebar
      }
    };
...
✅ Verification requested via WhatsApp.`;
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto bg-white border border-gray-200 shadow-[0_20px_60px_rgba(0,0,0,0.15)]"
      onKeyDown={(e) => e.stopPropagation()}>
        ...
        <div className="flex items-center justify-center gap-2 pb-4">
          <div className={`flex items-center justify-center w-8 h-8 rounded-full text-sm font-bold
            ${step === 'form' ? 'bg-primary text-white' : 'bg-green-500 text-white'}`}>
            {step === 'form' ? '1' : <CheckCircle2 className="w-5 h-5" />}
          </div>
          <div className={`w-12 h-1 rounded ${step === 'form' ? 'bg-gray-200' : 'bg-green-500'}`} />
          <div className={`flex items-center justify-center w-8 h-8 rounded-full text-sm font-bold
            ${step === 'payment' ? 'bg-primary text-white' : step === 'success' ? 'bg-green-500 text-white' : 'bg-gray-200 text-gray-400'}`}>
        ...
        <div className="bg-gray-50 border border-gray-200 p-4 rounded-lg mb-4">
          <div className="flex justify-between items-center">
            ...
            <div className="text-right">
              <p className="text-sm text-gray-500 font-medium">Final Amount</p>
          ...
          <form onSubmit={handleFormSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="name" className="flex items-center gap-2 text-gray-700 font-semibold text-sm">
                ...
                <Input
                  ...
                  className="h-11 bg-white border-gray-300 text-gray-800 focus:border-primary"
                  required
                />
              </div>

              <div className="space-y-2">
                <Label htmlFor="fatherName" className="flex items-center gap-2 text-gray-700 font-semibold text-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-11 pl-[75px] bg-white border-gray-300 text-gray-800 focus:border-primary"
                    pattern="[0-9]{10}"
                    required
                  />
                  <div className="absolute left-0 top-0 h-full flex items-center border-r border-gray-300 bg-gray-50 rounded-l-md px-2">
              ...
              <div className="space-y-2">
                <Label htmlFor="profession" className="flex items-center gap-2 text-gray-700 font-semibold text-sm">
            ...
            <div className="space-y-2">
              <Label htmlFor="address" className="flex items-center gap-2 text-gray-700 font-semibold text-sm">
              ...
              <Textarea
                ...
                className="min-h-[80px] resize-none bg-white border-gray-300 text-gray-800 focus:border-primary"
                required
              />
            </div>
            ...
            <div className="flex gap-3 pt-4">
              ...
              <Button type="submit" className="flex-1 bg-gradient-to-r from-primary to-accent text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-primary/60 bg-gray-50 transition-colors">
                    <input
                      type="file"
                      accept="image/*"
                    ...
                    <label htmlFor="screenshot-upload" className="cursor-pointer flex flex-col items-center gap-1">
                      {screenshotPreview ? (
                        ...
                        <>
                          ...
                          <p className="text-[10px] text-gray-400">Click to upload screenshot</p>
                        </>
                      )}
                    </label>
                  </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="utr" className="flex items-center gap-2 text-gray-700 font-semibold text-sm">
                  ...
                  <Input
                    ...
                    className="h-10 font-mono bg-white border-gray-300 text-gray-800 focus:border-primary"
                    required
                  />
                </div>
              </div>
        ...
        {step === 'success' && (
          <div className="space-y-8 py-4">
            ...
            <Button
              ...
              className="w-full h-14 bg-gradient-to-r from-primary to-accent text-white text-lg font-bold shadow-lg"
            >
